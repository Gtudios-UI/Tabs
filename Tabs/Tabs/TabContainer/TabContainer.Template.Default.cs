...
partial class TabContainer<T>
{
    static ExternalControlTemplate<TabContainerTemplateParts<T>, TabContainer<T>, HeaderFooterContent> DefaultTemplate { get; } =
        (@this, item) =>
        {
            ...
            {
                Content = new ConstantContentBundle(
                    new ScrollViewer
                    {
                        ...
                        Content = new OrientedStack
                        {
                            Children =
                            {
                                ...
                                {
                                    MinWidth = 100,
                                    Height = SelfNote.ThrowNotImplemented<double>(), // {TemplateBinding Height}
                        ...
                        .WithCustomCode(x => x.OrientationProperty.Bind(@this.OrientationProperty, ReadOnlyBindingModes.OneWay))
                    }
